...
//    m_mainGridLayout->addWidget( viewerWidget, 0, 1, 4, 1 );
    m_mainGridLayout->addWidget( labelLeft, 0, 0, 1, 1 , Qt::AlignCenter | Qt::AlignHCenter );
    m_mainGridLayout->addWidget( labelRight, 0, 1, 1, 1 , Qt::AlignCenter | Qt::AlignHCenter );
